...
Assuming we have a file called `examples/ocean.jpg` in `data/img/examples/ocean.jpg`, the following line of code would generate the optimized image.

```
![ocean](/static/images/examples/ocean.jpg)
```
...
```js
<Image alt="ocean" src="/static/images/examples/ocean.jpg" width={256} height={128} />
```
