...
`data/videosData.js` - data used to generate styled card in projects page.
...
images: ['/static/images/examples/canada/mountains.jpg', '/static/images/examples/canada/toronto.jpg']
